      ...
      <div class="nav-bar">
        <div v-if="productInfo" class="container">
          <router-link style="text-decoration: none" title="官网" to="/MallHome">
            <el-image :src="productInfo.productUrl" class="logo"
                      style="width: 65px;height: 65px;margin-top: 10px;margin-right: 15px;"></el-image>
          </router-link>
          ...
          <el-button plain round style="position: absolute;right: 0;top: 28px" @click="toBuy">立即购买</el-button>
        </div>
      </div>
    </div>
    <div class="page-main">
      <div class="review-box">
        ...
        <div v-if="productReview && productReview.length!==0" class="review-content">
          <div v-for="review in productReview" :key="review.reviewId" class="review-item">
            <div class="user-info">
              <el-avatar :size="50" :src="review.avatarUrl" class="user-avatar" @error="errorHandler">
              ...
              <div class="info">
                ...
                <span v-if="review.productSpecs">
                  ...
                  <span class="product-specs">
                    农产品规格：{{ review.productSpecs }}
                  </span>
                </span>
              </div>
              <div class="star-level">
                <el-rate v-model="review.starLevel" disabled show-text text-color="#ff9900"></el-rate>
              </div>
            </div>
