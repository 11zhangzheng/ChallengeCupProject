<template>
  <div class="mall-product">
    <!--回到顶部-->
    <el-backtop style="height: 50px;width: 50px" target=".mall-product">
    ...
    <div class="mall-info clearfix">
      ...
      <div v-if="productInfo" class="mall-container clearfix">
          ...
          <li v-for="(product,index) in this.productInfo" :key="index" @click="buy(product.productId)">
            ...
            <div class="pro-con">
              ...
              <div style="position: absolute;bottom: 30px;">
                <el-button size="small" style="padding: 9px 29px;" type="danger">
