...
<template>
  <div class="product-list">
    ...
    <el-card class="box-card product-list-card" shadow="never">
      ...
      <div>
        <el-table :data="tableData" height="500px" border slot="empty" stripe highlight-current-row style="width: 100%">
            ...
            <el-table-column label="农产品图片" align="center" width="150">
            ...
            <el-table-column label="农产品名称" align="center" width="300">
              <template slot-scope="scope" >
            ...
            <el-table-column label="操作" align="center" min-width="150">
              <template slot-scope="scope">
                <div>
                  <el-button size="mini" type="danger" slot="reference" @click="purchase(scope.$index)" style="margin-bottom: 20px!important;">农产品采购</el-button>
                </div>
                <div>
    ...
    <el-dialog title="编辑农产品" class="chang-product" :visible.sync="dialogFormVisible" center v-if="tableData[handleIndex]">
      <el-form class="el-form" inline :rules="alterRules" :model="alterForm" ref='changeFrom'>
        ...
        <el-form-item label="农产品进价：" prop="inPrice">
          <el-input type='number' min=0 v-model="alterForm.inPrice" placeholder="农产品进价"></el-input>
        </el-form-item>
        ...
        <el-form-item label="农产品售价：" prop="outPrice">
          <el-input type='number' min=0 v-model="alterForm.outPrice" placeholder="农产品售价"></el-input>
        </el-form-item>
        ...
        <el-form-item label="农产品描述：" prop="productDescribe">
          <el-input type="textarea" autosize v-model="alterForm.productDescribe" placeholder="农产品描述"></el-input>
        </el-form-item>
    ...
    <el-dialog title="农产品采购" class="chang-purchase" :close-on-click-modal="false" :visible.sync="purchaseFormVisible" width="500px" center>
      <el-form class="info-form" inline :model="purchaseForm" :rules="purchaseRules" ref='changeFrom'>
        <el-form-item label="农产品编号：" prop="productNo">
          <el-input size="small" readonly v-model="purchaseForm.productNo" placeholder="农产品编号"></el-input>
        </el-form-item>
        <el-form-item label="农产品名称：" prop="productName">
          <el-input size="small" readonly v-model="purchaseForm.productName" placeholder="农产品名称"></el-input>
        </el-form-item>
