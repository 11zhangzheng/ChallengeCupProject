      ...
      <div class="info-box">
        <el-form class="product-form" :model="productForm" :inline="true" :rules="productRules" ref="ruleForm">
          ...
          <el-form-item label="农产品规格：" prop="productSpec" style="width: 50%">
            <el-select size="small" class="select-spec" v-model="productSpec" multiple placeholder="请选择农产品规格" style="width: 245px;">
          ...
          <el-form-item label="农产品进价：" prop="inPrice" style="width: 45%;">
            <el-input min=0 size="small" type='number' v-model="productForm.inPrice" placeholder="农产品进价"></el-input>
          </el-form-item>
          <el-form-item label="农产品库存：" prop="productStock" style="width: 45%;">
            <el-input-number size="small" :min=0 :max=1000 v-model="productForm.productStock" placeholder="农产品库存"></el-input-number>
          </el-form-item>
          <el-form-item label="农产品售价：" prop="outPrice" style="width: 45%;">
            <el-input min=0 size="small" type='number' v-model="productForm.outPrice" placeholder="农产品售价"></el-input>
          </el-form-item>
          ...
          <el-form-item style="width:100%;text-align: center;position: absolute;bottom: -14px;left: 0">
            <el-button  @click="submitForm('ruleForm')" type="primary" style="margin: 0 55px">添加农产品</el-button>
