    ...
    <el-card class="box-card order-list-card" shadow="never">
      ...
      <div>
        <el-table slot="empty" :data="tableData" border height="500px" highlight-current-row stripe style="width: 100%">
          <el-table-column align="center" label="编号" prop="orderId" width="50"></el-table-column>
          <el-table-column align="center" label="订单编号" prop="orderNo" width="140"></el-table-column>
          <el-table-column align="center" label="提交时间" prop="orderTime" width="180"></el-table-column>
          <el-table-column align="center" label="农产品编号" prop="productNo" width="180"></el-table-column>
          <el-table-column align="center" label="用户名称" width="140">
            <template slot-scope="scope">
              <el-tooltip v-if="tableData" :content="'帐号：'+tableData[scope.$index].userAccount+', 联系方式：'+
                          tableData[scope.$index].contactWay+', 地址：'+tableData[scope.$index].acceptAddress" class="item" effect="dark"
                          placement="right">
                <p style="cursor: pointer" v-text="tableData[scope.$index].userName"></p>
              </el-tooltip>
            </template>

          </el-table-column>
          <el-table-column align="center" label="订单金额" prop="payPrice" width="140"></el-table-column>
          <el-table-column align="center" label="支付方式" prop="payType" width="140"></el-table-column>
          <el-table-column align="center" label="订单来源" prop="orderFrom" width="140"></el-table-column>
          <el-table-column align="center" label="订单状态" prop="orderState" width="140"></el-table-column>
          <el-table-column align="center" label="操作" min-width="150">
            <template slot-scope="scope">
              <el-button v-if="tableData[scope.$index].orderState==='待发货'" size="mini" type="danger"
                         @click="sendGoods(scope.$index)">确认发货
              </el-button>
              <el-button v-else size="mini" @click="orderInfo(scope.$index)">订单详情</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
    ...
    <el-dialog :close-on-click-modal="false" :visible.sync="dialogFormVisible" center class="logistics"
      ...
      <el-form ref='changeFrom' :model="alterForm" :rules="alterRules" class="info-form" inline>
        ...
        <el-form-item label="收货人联系方式：" prop="receiverTel">
          <el-input v-model="alterForm.receiverTel" placeholder="收货人联系方式" size="small"></el-input>
        </el-form-item>
        <el-form-item label="收货人地址：" prop="contactWay" style="width: 100%">
          <el-input v-model="alterForm.receiverAdd" placeholder="收货人地址" size="small"></el-input>
        </el-form-item>
