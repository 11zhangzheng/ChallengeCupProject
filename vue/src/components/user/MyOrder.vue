<template>
  <div class="my-order">
      ...
      <el-tabs class="order-list" stretch v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="全部订单" name="first">
          <el-table :data="orderData" class="order-table" center>
            ...
            <el-table-column prop="productNo" label="农产品编号" align="center" width="180"></el-table-column>
            ...
            <el-table-column align="center" label="操作">
              <template slot-scope="scope">
                <el-button
                  ...
                  @click="payment(scope.row.orderNo,scope.row.orderTime,scope.row.productName,scope.row.payPrice,scope.row.productType)">农产品付款</el-button>
                <el-button
                  size="mini"
    ...
    <el-dialog title="农产品评价" class="review" :visible.sync="reviewFormVisible" top="20vh" width="500px">
      <el-form :model="reviewFrom" :rules="reviewRules" ref="reviewFrom">
        <el-form-item label="农产品名称" required  prop="productName">
          <el-input size="small" v-model="reviewFrom.productName" readonly placeholder="农产品名称"></el-input>
        </el-form-item>
        <el-form-item v-if="reviewFrom.productSpecs" required label="农产品规格"  prop="productSpecs">
          <el-input size="small" v-model="reviewFrom.productSpecs" readonly placeholder="农产品规格"></el-input>
        </el-form-item>
